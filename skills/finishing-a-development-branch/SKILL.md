...
**Core principle:** Verify tests → confirm clean committed work → detect environment → present options → execute choice → clean up.
...
### Step 2: Verify Git State And Detect Environment
