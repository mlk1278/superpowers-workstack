...
Task tool (general-purpose):
  ...
  prompt: |
    ...
    **Architecture:**
    ...
    - Business rules and security-sensitive decisions in the canonical layer?
    ...
    **Testing:**
    ...
    - Any E2E/browser/API+DB/full-stack verification claim backed by runtime preflight evidence?
