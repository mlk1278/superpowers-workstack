...
assert_not_contains "tests/codex/test-marketplace-manifest.sh" "omits unrelated marketplace test"
assert_not_contains "tests/codex-plugin-sync/test-sync-to-codex-plugin.sh" "omits unrelated Codex sync test"
assert_not_contains "tests/claude-code/test-sdd-workspace.sh" "omits unrelated SDD workspace test"
